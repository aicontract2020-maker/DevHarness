...
4. Create the exact AIedu_demo declaration as the consumer-owned configuration for developer review.
5. Validate contracts and runtime behavior without launching AIedu_demo.
