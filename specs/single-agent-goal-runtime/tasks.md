...
- [ ] **TASK-025** [M] Test lease ownership and commit/cancel fencing
...
- [ ] **TASK-026** [M] Implement leases and the shared terminal fence
  - Creates: `packages/runtime/src/operation-lease.mjs`
  - Plan/contract: § Persistence; `contracts/live-alignment.md` § Idempotency and Recovery
  - Satisfies: AC-10, AC-11, AC-14
  - Depends on: TASK-025

- [ ] **TASK-027** [M] Test prepared checkpoints and recovery
...
- [ ] **TASK-028** [M] Implement crash-safe operation transactions
...
- [ ] **TASK-029** [M] [P] Test snapshots and macOS Seatbelt narrowing
...
- [ ] **TASK-030** [M] Implement analysis views and macOS probes
...
- [ ] **TASK-031** [M] Test worker ownership, budgets and cleanup
...
- [ ] **TASK-032** [M] Implement the bounded Agent worker
...
- [ ] **TASK-033** [M] Test the parent-owned provider proxy
...
- [ ] **TASK-034** [M] Implement provider credential injection outside the Agent
...
- [ ] **TASK-035** [S] [P] Test exact-HTTPS research policy
...
- [ ] **TASK-036** [S] Implement deterministic research request policy
...
- [ ] **TASK-037** [M] Test gateway I/O, terminal triplets and recovery
...
- [ ] **TASK-038** [M] Implement the controlled research gateway
...
- [ ] **TASK-039** [M] [P] Test claims, coverage, materiality and readiness
...
- [ ] **TASK-040** [M] Implement deterministic alignment verdicts
...
- [ ] **TASK-041** [M] Test the extended interaction contract and policy
...
- [ ] **TASK-042** [M] Implement alignment packet validation and policy
...
- [ ] **TASK-043** [M] Test bundle and compact-packet projection
...
- [ ] **TASK-044** [M] Implement validated bundle and packet projection
...
- [ ] **TASK-045** [S] Test local phases and legal transitions
...
- [ ] **TASK-046** [S] Implement deterministic phase transitions
...
- [ ] **TASK-047** [M] Test operation start, planning and research pauses
...
- [ ] **TASK-048** [M] Implement start, planning and research phases
...
- [ ] **TASK-049** [M] Test synthesis, fresh validation and publication
...
- [ ] **TASK-050** [M] Implement synthesis, validation and publication
...
- [ ] **TASK-051** [M] Test retry, cancellation and restart
...
- [ ] **TASK-052** [M] Implement retry, cancellation and reconciliation
...
- [ ] **TASK-053** [M] Test exact Agent authority binding
...
- [ ] **TASK-054** [M] Integrate static Agent selection and authorization
...
- [ ] **TASK-055** [M] Test authenticated answers and stale refusal
...
- [ ] **TASK-056** [M] Implement Supervisor-attested answers
...
- [ ] **TASK-057** [M] Test checkpoint publication and derived scope
...
- [ ] **TASK-058** [M] Integrate with the Goal Run checkpoint store
...
- [ ] **TASK-059** [M] Test the complete CLI surface
...
- [ ] **TASK-060** [M] Expose live alignment through the CLI
...
- [ ] **TASK-061** [S] Test review-client mapping
...
- [ ] **TASK-062** [S] Implement review-client mapping for the live brief
...
- [ ] **TASK-063** [M] Write real-browser review-page functional/system tests
...
- [ ] **TASK-064** [M] Implement the live Alignment Brief page
  - Modifies: `apps/review-ui/app/page.tsx`
  - Plan/contract: § Human review; `contracts/live-alignment.md` § Interaction Packet
  - Satisfies: AC-3, AC-4, AC-5, AC-6, AC-7, AC-8, AC-12
  - Depends on: TASK-063

- [ ] **TASK-065** [M] Prove provider-neutral full-pipeline conformance
...
- [ ] **TASK-066** [M] Add fake-Agent end-to-end acceptance proof
...
- [ ] **TASK-067** [M] Add crash/race/hostile-input system proof
...
- [ ] **TASK-068** [S] Add opt-in real-Codex macOS smoke proof
...
- [ ] **TASK-069** [S] Document the bounded v0 workflow and evidence
  - Modifies: `README.md`
