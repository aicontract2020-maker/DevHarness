...
| AC-2 | MUST | Foreground presentation test; real example-consumer pending request | `packages/runtime/src/supervisor-approval.mjs` | ✓ PASS |
...
| AC-7 | MUST | CLI test plus example-consumer clean status before/after | external storage boundary | ✓ PASS |
...
- Real example-consumer Goal Run exposed seven bounded capability requests at revision `49a4c5dfd344`.
...
- example-consumer Git working tree remained clean.
